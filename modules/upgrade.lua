...
new = function ( params )
	...
	local upgradeBackground01 = display.newImage( images.STORAGE_UPGRADE )
	local upgradeBackground02 = display.newImage( images.MILITARY_UPGRADE )
	local upgradeBackground03 = display.newImage( images.REFINERY_UPGRADE )
	local upgradeBackground04 = display.newImage( images.TRANSPORT_UPGRADE )
	...
	local initVars = function ()
		...
		--		
		--
		upgradeBackground03.x = 325
		upgradeBackground03.y = 600
		--
		--
		upgradeBackground04.x = 290
