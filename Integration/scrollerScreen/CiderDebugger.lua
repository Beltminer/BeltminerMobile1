local CiderRunMode = {};CiderRunMode.runmode = true;CiderRunMode.sdk = "Corona";CiderRunMode.assertImage = true;CiderRunMode.userdir = "/Users/Scot/Library/Application Support/LuaGlider/dev";local CORONA_SOCKET_PORT=51248;local SOCKET_PORT=51249;local GLIDER_MAIN_FOLDER= "/Users/Scot/Documents/iPhoneDev_Projects/BeltminderProjects/HomeScreen";local useNativePrint= false;
--v1.69
-----------------------------------------------------------------------------------------
--
-- main.lua
